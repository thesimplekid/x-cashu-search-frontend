...
export function wallet_checkAllPendingProofs(a: number, b: number, c: number): number;
...
export function wasm_bindgen__convert__closures__invoke1_mut__h50a7e597e59c210d(a: number, b: number, c: number, d: number): void;
export function _dyn_core__ops__function__FnMut__A____Output___R_as_wasm_bindgen__closure__WasmClosure___describe__invoke__hafd472cd0d91c086(a: number, b: number, c: number): void;
export function __wbindgen_free(a: number, b: number, c: number): void;
export function __wbindgen_exn_store(a: number): void;
export function wasm_bindgen__convert__closures__invoke2_mut__h2d7fdefda58b8253(a: number, b: number, c: number, d: number): void;
