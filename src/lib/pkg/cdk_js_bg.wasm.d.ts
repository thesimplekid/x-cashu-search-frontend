...
export function wallet_new(): number;
...
export function wallet_mint(a: number, b: number, c: number, d: number, e: number): number;
export function wallet_meltQuote(a: number, b: number, c: number, d: number, e: number, f: number): number;
export function wallet_meltQuoteStatus(a: number, b: number, c: number, d: number, e: number): number;
export function wallet_melt(a: number, b: number, c: number, d: number, e: number): number;
export function wallet_receive(a: number, b: number, c: number, d: number, e: number): number;
export function wallet_send(a: number, b: number, c: number, d: number, e: number, f: number, g: number, h: number, i: number): number;
export function wallet_swap(a: number, b: number, c: number, d: number, e: number, f: number, g: number, h: number, i: number): number;
...
export function meltquotebolt11response_paid(a: number): number;
export function meltquotebolt11response_expiry(a: number): number;
export function meltquotebolt11response_quote(a: number, b: number): void;
export function meltquotebolt11response_amount(a: number): number;
export function meltquotebolt11response_fee_reserve(a: number): number;
...
export function wasm_bindgen__convert__closures__invoke1_mut__h4a3e7a5696b040bf(a: number, b: number, c: number, d: number): void;
export function _dyn_core__ops__function__FnMut__A____Output___R_as_wasm_bindgen__closure__WasmClosure___describe__invoke__haa80418c486d8f53(a: number, b: number, c: number): void;
export function __wbindgen_free(a: number, b: number, c: number): void;
export function __wbindgen_exn_store(a: number): void;
export function wasm_bindgen__convert__closures__invoke2_mut__h4e356961ed88fa4e(a: number, b: number, c: number, d: number): void;
